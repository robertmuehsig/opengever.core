...
class TestOfficeconnectorDossierAPIWithAttach(OCIntegrationTestCase):
    ...
    def test_attach_to_email_resolved_without_file(self, browser):
        ...
        with browser.expect_http_error(404):
            oc_url = self.fetch_document_attach_oc_url(browser, self.resolved_document)
    ...
    def test_attach_to_email_resolved_with_file(self, browser):
        ...
        self.assertEquals(200, browser.status_code)
        self.validate_attach_payload(payloads[0], self.resolved_document)
        ...
        self.assertEquals(file_contents, self.resolved_document.file.data)
